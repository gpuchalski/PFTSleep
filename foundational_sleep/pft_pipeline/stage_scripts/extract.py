...
num_files = globals().get("num_files", 1219)
...
loader = DataLoader(
    ...
    prefetch_factor=2,       # each worker stages 2 batches ahead of the GPU
    drop_last=False,         # keep the final partial batch
)
print(f"Dataset + DataLoader ready (batch_size={batch_size}, workers={workers}).")
